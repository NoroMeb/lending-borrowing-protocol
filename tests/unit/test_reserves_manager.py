...
def test_deploy_reserves_manager(skip_live_testing, pool, dai):
    # arrange
    skip_live_testing
    account = get_account()
...
def test_get_reserve_balance(skip_live_testing, pool, dai, link):
    # arrange
    skip_live_testing
    reserves_manager = test_deploy_reserves_manager(skip_live_testing, pool, dai)
